...
class loginWindow(Screen):
    ...
    def validate(self):
        ...
        if self.username.text not in users['Name'].unique():
            ...
            account=[self.username.text,self.pwd.text]
...
class otpmobileWindow(Screen):
    ...
    def sendotpmob(self):
        ...
        if k not in users['Name'].unique():
            ...
            client = Client("AC071b2848e866d06d7d91cabd1bda3a34",
                            "3639203184b4d6e86a96b60d09b5d5a2")
...
class accountWindow(Screen):
    def deleteprofile(self):
        ...
        # users = pd.read_csv('nivelogin.csv')
        # if p in users['Name'].unique():
        #     users.drop((users.index[users["Name"] == p]),axis=0,inplace=True)
        #     print("success")
        ...
        members= input("Please enter username to be deleted.")

        with open('nivelogin.csv', 'r') as readFile:
        ...
        with open('nivelogin.csv', 'w') as writeFile:
    ...
    def delete(self):
        filePath = "nivelogin.csv"


class passwordWindow(Screen):

    def password(self):
        members = input("Please enter a password to be change.")
...
sm.add_widget(passwordWindow(name='password'))
